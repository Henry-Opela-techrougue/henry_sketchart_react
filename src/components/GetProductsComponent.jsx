...
const GetProductsComponent = () => {
    ...
    // //     let filtered_products=products.filter((product)=>product.product_name.toLowerCase().includes(search_word.toLowerCase()),)
    // // }
            ...
            <div className="col-md-3 justify-content-center mb-4">
                <div className="card shadow card-margin hero">
                    <div className="card-body">
                        <h6 className="text-dark" onClick={() => { navigator("/pencils") }}>Pencils</h6>
                    </div>
                </div>
            </div>

            <div className="col-md-3 justify-content-center mb-4">
                <div className="card shadow card-margin beru">
                    <div className="card-body">
                        <h6 className="text-dark" onClick={() => { navigator("/erasers") }}>Erasers</h6>
                    </div>
                </div>
            </div>

            <div className="col-md-3 justify-content-center mb-4">
                <div className="card shadow card-margin igris">
                    <div className="card-body">
                        <h6 className="text-dark" onClick={() => { navigator("/refartbks") }}>RefArt Books</h6>
                    </div>
                </div>
            </div>

            <div className="col-md-3 justify-content-center mb-4">
                <div className="card shadow card-margin iron">
                    <div className="card-body">
                        <h6 className="text-dark" onClick={() => { navigator("/artbooks") }}>ArtBooks</h6>
                    </div>
                </div>
            </div>
            {/* end of first row */}
